...
public class Alarms {
    ...
    public static final String ALARM_ALERT_ACTION = "com.yesterday.like.deskclock.ALARM_ALERT";
    ...
    public static final String ALARM_DONE_ACTION = "com.yesterday.like.deskclock.ALARM_DONE";
    ...
    public static final String ALARM_SNOOZE_ACTION = "com.yesterday.like.deskclock.ALARM_SNOOZE";

    // AlarmAlertFullScreen listens for this broadcast intent, so that other applications
    // can dismiss the alarm (after ALARM_ALERT_ACTION and before ALARM_DONE_ACTION).
    public static final String ALARM_DISMISS_ACTION = "com.yesterday.like.deskclock.ALARM_DISMISS";
    ...
    public static final String ALARM_SNOOZE_CANCELLED = "com.yesterday.like.deskclock.ALARM_SNOOZE_CANCELLED";

    // A broadcast sent every time the next alarm time is set in the system
    public static final String NEXT_ALARM_TIME_SET = "com.yesterday.like.deskclock.NEXT_ALARM_TIME_SET";
