...
package com.yesterday.like.alarmclock;
...
import com.yesterday.like.deskclock.R;
import com.yesterday.like.deskclock.Alarms;
import com.yesterday.like.deskclock.Utils;
import com.yesterday.like.deskclock.worldclock.CityObj;
import com.yesterday.like.deskclock.worldclock.WorldClockAdapter;
...
public class DigitalWidgetViewsFactory extends BroadcastReceiver implements RemoteViewsFactory {
    ...
    public void onCreate() {
        ...
        filter.addAction("com.yesterday.like.deskclock.NEXT_ALARM_TIME_SET");
        filter.addAction("com.yesterday.like.deskclock.worldclock.update");
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals("com.yesterday.like.deskclock.NEXT_ALARM_TIME_SET")) {
        ...
        } else if (action.equals("com.yesterday.like.deskclock.worldclock.update")) {
